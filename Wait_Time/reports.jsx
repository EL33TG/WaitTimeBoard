<>
  ...
  <div className="sidebar">
    <img
      src="https://innovativenerds.com/WaitTime/images/bg-02.jpg"
      width={230}
      height={105}
    />{" "}
    <br />
  ...
  <div className="container-main100">
    <div className="main">
      <center>
        ...
        <br />
        <h3>
          This is where all of our reports &amp; data information will go.
        </h3>
        <br />
        <p>Nothing Here Yet, Working on Buildout!</p>
        <hr />
        <hr />
        <br />
